...
use Illuminate\Support\Facades\Route;
    ...
    Route::get('/category', [ClientController::class, 'category_page'])->name('category_page');
    Route::get('/single-product', [ClientController::class, 'single_product'])->name('single_product');
